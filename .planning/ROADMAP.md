...
- [x] 01-05-PLAN.md (wave 1, gap closure) — Cierre de gaps BL-01 (CONV-02 TOCTOU 500 → 404) y BL-02 (SEC-01 canonicalización UUID en path) — completed 2026-05-09 (commits `bbb4120`, `f4d37dc`)
...
**Plans:** 5 plans
Plans:
- [ ] 03-01-PLAN.md (wave 1) — Foundation: PROFILES dict en config.py + reasoning kwarg opcional en query_model (QUAL-02, RSCH-01)
- [ ] 03-02-PLAN.md (wave 2) — Routing por profile en SendMessageRequest + council.py para fast/quality (placeholder QR) (QUAL-01)
...
| 3. Quality Dial & Pragmatic Deep Research | 0/5 | Not started | - |
