...
**Plans:** 5/5 complete
- [x] 05-01-PLAN.md — Schema migration v1→v2 + mode/external_research storage shape (Wave 0) — completed 2026-05-10
- [x] 05-02-PLAN.md — Backend critique pipeline: POST /critique/stream + anonymization + truncate + n=1/2/3 SSE (Wave 1) — completed 2026-05-10
- [x] 05-03-PLAN.md — Frontend critique entry: sidebar button + pill + CritiqueWelcome + DropZoneSlot + rate-limit (Wave 2) — completed 2026-05-10
- [x] 05-04-PLAN.md — File chip hydration on reload (CRIT-08 ExternalResearchPanel) (Wave 3) — completed 2026-05-10
- [x] 05-05-PLAN.md — In-conversation navigation: sticky headers + StageNavigationStrip + Show-more + Back-to-top (Wave 4) — completed 2026-05-10
**UI hint**: yes
...
- [ ] 06-05-PLAN.md — SET-04 FOUC blocker extension (density + fontSize sync) + index.css overrides (Wave 1)
...
- **OpenRouter `usage.cost` shape verification** (CRIT-2): 5-min spike (log de un response real) — owned por Phase 6 plan-01 (Wave 1 gate).
